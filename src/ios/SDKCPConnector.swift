...
@objc(cpOrderItem)
public class cpOrderItem: Codable {
    public init() {
        
    }
    public init(sku: String, name: String, qty: Int, unitPrice: Double) {
        self.sku = sku
        self.name = name
        self.qty = qty
...
@objc(cpCartItem)
public class cpCartItem: Codable {
    public init(sku: String, name: String, qty: Int, unitPrice: Double, link: String, image: String) {
        self.sku = sku
        self.name = name
        self.qty = qty
        self.unitPrice = unitPrice
...
public class cpConnectionService{
    ...
    @objc
    public func isPushEnabledAtOSLevel(checkNotificationStatus isEnable : ((Bool)->())? = nil){
